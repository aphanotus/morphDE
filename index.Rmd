...
> ℹ️ While any process is running on nscc, you can monitor it's progress indirectly by checking the CPU usage on [NSCC node 28](http://schupflab.colby.edu/mrtg/nscc/nscc-n28.load.html).
...
| ovaries | -     | by stage | GO       | 9              | GO:0006260(L=5) DNA replication, 1.10×10<sup>-9</sup>; GO:0034061(L=5) DNA polymerase activity, 1.19×10<sup>-8</sup>; GO:0003964(L=6) RNA-directed DNA polymerase activity, 5.30×10<sup>-7</sup>; GO:0006278(L=7) RNA-dependent DNA biosynthetic process, 5.30×10<sup>-7</sup>; GO:0006259(L=4) DNA metabolic process, 1.70×10<sup>-6</sup>; GO:0016779(L=4) nucleotidyltransferase activity, 0.000765; GO:0015074(L=5) DNA integration, 0.007542; GO:000452(L=8) RNA-DNA hybrid ribonuclease activity, 0.0124; GO:0005319(L=3) lipid transporter activity, 0.0414; GO:0070001(L=5) aspartic-type peptidase activity, 0.0507 |
